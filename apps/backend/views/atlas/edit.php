...
<div class="pad_10">
	<form
		action="<?php echo YUrl::createBackendUrl('', 'Atlas', 'edit'); ?>"
        ...
        <?php endforeach; ?>
			...
			<tr>
				...
				<td><?=isset($frontend_url)?$frontend_url:''?>atlas/<input type="text"
...
$(document).ready(function(){
	...
	//建立已有的东西
	var images = <?=$detail['content']?>;
	for (var i in images) {
		addAtlasContent(images[i].img, images[i].intro);
	}
