...
class Validator {
    ...
    public static $rule_txt = [
            'qq' => '%label%格式不正确','mobilephone' => '%label%格式不正确','telephone' => '%label%格式不正确',
            'zipcode' => '%label%格式不正确','number_between' => '%label%必须在%min%到%max%之间','chinese' => '%label%必须为中文',
            'idcard' => '%label%格式不正确','integer' => '%label%必须为整型','ip' => '%label%格式不正确',
            'url' => '%label%格式不正确','utf8' => '%label%必须为UTF-8字符','email' => '%label%格式不正确',
            'require' => '%label%不能为空','len' => '%label%长度必须在%min%~%max%之间','date' => '%label%格式不正确',
            'alpha' => '%label%必须为字母','alpha_number' => '%label%只能是字母或数字',
            'alpha_between' => '%label%字母必须在%start%~%end%之间','alpha_dash' => '%label%必须由字母、数字、下划线(_)、破拆号(-)组成',
            'mac' => '%label%格式不正确','float' => '%label%格式不正确','boolean' => '%label%格式不正确' 
    ];
    ...
    public static function is_mobilephone($mobilephone) {
        return preg_match('/^1(3|4|5|7|8)[\d]{9}$/', $mobilephone) ? true : false;
    }
